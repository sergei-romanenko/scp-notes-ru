...
суперкомпиляторов
[SPSC](https://sergei-romanenko.github.io/spsc/) и
...
Например, суперкомпилятор
[SCP4](http://www.supercompilers.com/html/scp_4_docs.html)
предназначен для обработки программ на Рефале, а в Рефале вызовы функций
вычисляются изнутри наружу. Так уж устроен Рефал, а когда появился
Рефал, до суперкомпиляции (и связанных с нею проблем) ещё никто не
додумался.
